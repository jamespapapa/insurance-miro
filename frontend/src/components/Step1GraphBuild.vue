    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">본체 생성</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM이 문서 내용과 시뮬레이션 요구를 분석하여 현실 시드를 추출하고, 적절한 온톨로지 구조를 자동 생성합니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase > 1" class="badge success">완료됨</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            생성된 온톨로지를 기반으로 문서를 자동으로 블록화한 뒤 Zep을 호출해 지식 그래프를 구축하고, 엔티티와 관계를 추출하며, 시계열 메모리와 커뮤니티 요약을 형성합니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">그래프 구축이 완료되었습니다, 다음 단계로 이동하여 시뮬레이션 환경을 구축해 주세요</p>
          <button
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? '생성 중...' : '환경 구축으로 이동 ➝' }}
          </button>
        </div>
      </div>
    </div>

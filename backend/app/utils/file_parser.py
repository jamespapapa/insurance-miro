...
def _read_text_with_fallback(file_path: str) -> str:
    """
    텍스트 파일을 읽고，UTF-8이 실패하면 자동으로 인코딩을 탐지합니다。
    
    다단계 폴백 전략을 사용：
    1. 먼저 UTF-8 디코딩을 시도
    2. charset_normalizer로 인코딩을 감지
    3. chardet로 인코딩 감지로 폴백
    4. 최종적으로 UTF-8 + errors='replace'를 안전장치로 사용

"""
OASIS 요구사항을 충족하는지 Profile 형식 생성 테스트
검증:
1. Twitter Profile이 CSV 형식으로 생성됨
2. Reddit Profile이 JSON 상세 형식으로 생성됨
"""
